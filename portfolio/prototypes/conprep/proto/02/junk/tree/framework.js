...
if(!this.options.keepBackgroundImage){this.deprecated.backgroundImage=this.element.getStyle("background-image");
...
},finish:function(){this.element.setStyle(Object.extend(this.deprecated,{backgroundColor:this.options.restorecolor}))
}});
