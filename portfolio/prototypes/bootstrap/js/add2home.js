...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			ca_es: 'Per instal·lar Bins App al vostre %device premeu %icon i llavors <strong>Afegir a pantalla d\'inici</strong>.',
			...
			en_us: 'Install Bins App on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
			es_es: 'Para instalar Bins app en su %device, pulse %icon y seleccione <strong>Añadir a pantalla de inicio</strong>.',
			...
			pt_br: 'Instale Bins App em seu %device: aperte %icon e selecione <strong>Adicionar à Tela Inicio</strong>.',
			pt_pt: 'Para instalar Bins App no seu %device, prima o %icon e depois o <strong>Adicionar ao ecrã principal</strong>.',
